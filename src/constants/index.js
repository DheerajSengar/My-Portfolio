...
const projects = [
  ...
  
  {
    ...
    description:
      " The system provides real-time flight availability, seat selection, and secure payment integration.  " ,  
      tags: [
      {
        name: "react",
        color: "blue-text-gradient",
...

  {
    ...
    description:
      "Developed a Food Management System using Node.js and Express.js, enabling restaurants, grocery stores, and individuals to efficiently list, manage, and donate surplus food to reduce waste.",  
        tags: [
      {
        name: "nextjs",
        color: "blue-text-gradient",
